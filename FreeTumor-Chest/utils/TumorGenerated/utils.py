...
# here we want to get predefined texture:
...
def get_tumor(args, volume_scan, mask_scan, tumor_type, texture, num_tumor=None, difference=None):
...
def SynthesisTumor(args, volume_scan, mask_scan, tumor_type, texture, num_tumor=None, difference=None):
    ...
    organ_volume, organ_mask = get_tumor(args, organ_volume, organ_mask, tumor_type, cut_texture, num_tumor, cut_difference)

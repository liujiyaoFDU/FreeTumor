...
parser.add_argument(
    "--save_img_path", default="./syn_data_save/kidney/img", type=str, help="test_img_path")
parser.add_argument(
    "--save_lab_path", default="./syn_data_save/kidney/lab", type=str, help="test_lab_path")
parser.add_argument(
        ...
        for idx, batch_data in enumerate(test_loader):
            ...
            with autocast(enabled=True):
                while try_times < 10 and output_flag is False:
                    ...
                    if 6 in list(torch.unique(new_lab.long())):
                        output_flag = True

...
# ======TODO========
# 测试集图像 / 标签
DATA_ROOT="/inspire/hdd/global_user/hejunjun-24017/jinye/data/nnunet/nnUNet_raw_data_base/nnUNet_raw_data/Task004_liver_tumor_CT"
TEST_DATA_PATH="${DATA_ROOT}/masked_imagesTs"
TEST_LABEL_PATH="${DATA_ROOT}/fixed_organ_labelsTs"
# 合成图像 / 标签保存位置
TARGET_ROOT="/inspire/hdd/global_user/hejunjun-24017/jinye/data/nnunet/nnUNet_raw_data_base/nnUNet_raw_data/Task204_liver_tumor_CT"

...
parser.add_argument("--use_ssl_pretrained", action="store_true", help="use VoCo pretrained weights")
...
parser.add_argument("--max_epochs", default=200, type=int, help="Flexible")

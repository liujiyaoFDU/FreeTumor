...
# 设置数据路径
TEST_DATA_PATH="/inspire/hdd/global_user/hejunjun-24017/jiyao/Project/202504_3D生成/20251015_tumor_synthesis/data/demo_CHAOS/imagesTr"
TEST_LABEL_PATH="/inspire/hdd/global_user/hejunjun-24017/jiyao/Project/202504_3D生成/20251015_tumor_synthesis/data/demo_CHAOS/labelsTr"
...
# 设置保存路径(合成结果保存位置)
SAVE_IMG_PATH="./syn_data_save/liver/img"
SAVE_LAB_PATH="./syn_data_save/liver/lab"

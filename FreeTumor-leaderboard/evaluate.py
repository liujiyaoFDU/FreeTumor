...
parser.add_argument(
    "--test_data_path", default="./input", type=str, help="test_data_path")
parser.add_argument(
    "--save_prediction_path", default="./pred/", type=str, help="test_prediction_path")
parser.add_argument(
    "--trained_pth", default="./FreeTumor_flare.pt", type=str, help="trained checkpoint directory")
...
def transfer_output(output):
    ...
    new_output[output > 0] = 0
    new_output[output == 2] = 1
    new_output[output == 4] = 1
    new_output[output == 6] = 1
    return new_output

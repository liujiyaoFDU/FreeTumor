...
**Note that for FLARE leaderboard, we train one model for all three abdomen tumor types, i.e., liver, pancreas, and kidney tumors**. For KiTS, we train on only kidney tumors.
